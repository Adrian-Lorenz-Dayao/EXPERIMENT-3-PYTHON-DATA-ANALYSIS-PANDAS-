...
print(b1)  #show output as markdown
```
...
print(bx)  #show output as markdown
```
...
print(toyota)  #show output as markdown
```
Test output:
...
print(pontiac) #show output as markdown
```
...
print(selected_cars)  #show output as markdown
```
